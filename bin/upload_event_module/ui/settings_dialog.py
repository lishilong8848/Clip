...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        change_i2_label = QLabel("I2变更群名称：")
        self.group_name_change_i2_input = QLineEdit()
        self.group_name_change_i2_input.setPlaceholderText("输入群名称（需与飞书群名一致）")
        form_layout.addWidget(change_i2_label)
        form_layout.addWidget(self.group_name_change_i2_input)
    ...
    def load_current_settings(self):
        ...
        self._sync_relay_test_btn_state()
        self.group_name_change_i2_input.setText(config.group_name_change_i2)
    ...
    def save_settings(self):
        ...
        group_name_change_i2 = self.group_name_change_i2_input.text().strip()
        ...
        if config.save(
            ...
            group_name_change_i2=group_name_change_i2,
    ...
    def reset_to_default(self):
        ...
        if idx >= 0:
            self.relay_webhook_format_combo.setCurrentIndex(idx)
        self._sync_relay_test_btn_state()
        self.group_name_change_i2_input.setText(DEFAULT_GROUP_NAME_CHANGE_I2)
